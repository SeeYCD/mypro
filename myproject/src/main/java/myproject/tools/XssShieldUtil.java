...
public class XssShieldUtil {
	...
	private static List<Object[]> getXssPatternList() {
		...
		ret.add(new Object[] {
				...
				+ "|onerror=|onerroupdate|onfilterchange"
				...
				+ "|onmousemove|onmousout|onmouseover|onmouseup"
				+ "|onmousewheel|onmove|onmoveend|onmovestart|onabort|onactivate|onafterprint|onafterupdate"
				+ "|onbefore|onbeforeactivate|onbeforecopy|onbeforecut"
				+ "|onbeforedeactivate|onbeforeeditocus|onbeforepaste"
				+ "|onbeforeprint|onbeforeunload|onbeforeupdate|onblur"
				+ "|onbounce|oncellchange|onchange|onclick|oncontextmenu|onpaste"
				+ "|onpropertychange|onreadystatechange|onreset"
				+ "|onresize|onresizend|onresizestart|onrowenter|onrowexit"
	...
	public static void main(String[] args) {
		...
		String value = null;
		value = XssShieldUtil
				.stripXss("pp<script> language=text/javascript>alert(document.cookie);</script>oo");
		...
		value = XssShieldUtil.stripXss("<wo是谁>");
		System.out.println("type-14: '" + value + "'");
		
		value = XssShieldUtil.stripXss("src = \'\"'''''ssss'");
